...
function DropdownMenuCheckboxItem({
  ...
  return (
    ...
    >
      <span
        className={cn("pointer-events-none absolute flex items-center justify-center", indicatorAt === "right" ? "end-2" : "start-2")}
